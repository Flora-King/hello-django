...
SECRET_KEY = 'django-insecure-=6m#cobobux=to!27xxq8fx4t=$3l=a#+iv2f27%qh-c^8uta!'
...
DATABASES = {
    'default': dj_database_url.parse(os.environ.get('postgres://jtgqrdnv:***@trumpet.db.elephantsql.com/jtgqrdnv'))
}
